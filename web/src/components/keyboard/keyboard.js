    ...
    return ( 
        <div className="container-keyboard">
            <div className="wrapper-keyboard">
                <div className="img-keyboard">
                    <img src="./images/2506_2506_logitech-g515-black-version.jpg" className='default-img'/>
                ...
                <div className="action-keyboard" data-aos = 'fade-right'>
                    ...
                    một thiết kế hiện đại, mỏng nhẹ. Bàn phím mỏng nhẹ cóvẻ ngoài sạch sẽ hơn, thẩm mỹ hơn và mang lại trải nghiệm <br/>
                     gõ phím hiệu suất cao. G515 cho phép trải nghiệm gõ phím hiệu quả và thoải mái hơn bằng cách kết hợp các switch <br/>
                      mỏng nhẹ với thiết kế mỏng hơn. </p>
                </div>
            </div>
